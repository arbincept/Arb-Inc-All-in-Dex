...
export default function RewardsClient() {
	...
	useEffect(() => {
		...
		const fetchStats = async () => {
			...
			try {
				...
				console.error("Error fetching APR:", e);
			}
	...
	const telegramShareUrl = referralLink
		? `https://t.me/share/url?url=${encodeURIComponent(referralLink)}&text=${encodeURIComponent("Trade with zero slippage issues and earn passive BNB holding rewards on Arbitrage Inception DEX:")}`
		: "";

	const twitterShareUrl = referralLink
		? `https://twitter.com/intent/tweet?text=${encodeURIComponent("Earn passive BNB yield and trade with optimized liquidity on @Arbitrageincept DEX:")}&url=${encodeURIComponent(referralLink)}`
		: "";
	...
	return (
		...
		>
			...
			>
				...
				>
					Empower your community with high-execution decentralized trading. Earn a{" "}
					<b style={{ color: "#facc15" }}>10% peer bonus</b> on all community reward
					points generated by your referred network from Diamond holding yield,
					DEX swaps, and limit orders.
				</p>
				...
				{!address ? (
					...
					>
						...
						>
							...
							<span style={{ color: "#94a3b8", fontSize: "12px" }}>
								⚡ <b>Direct BNB Conversion:</b> Points scale claimable BNB pool
							</span>
							<span style={{ color: "#94a3b8", fontSize: "12px" }}>
